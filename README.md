...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/circuitq-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13704&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/circuitq-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `circuitq` can be installed with:

```
conda install circuitq
```

It is possible to list all of the versions of `circuitq` available on your platform with:
